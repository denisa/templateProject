...
public class DataSetup {
    ...
    public void seedDataBase() {
        entityManager.persist(new li.antonio.templateProject.endpoints.Country("Spain"));
        entityManager.persist(new li.antonio.templateProject.endpoints.Country("Italy"));
    }
